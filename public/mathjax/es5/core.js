                    ...
                    return (
                        ...
                        (t.prototype.setAttributes = function (t, e) {
                            ...
                            if (e.properties)
                                try {
                                    for (
                                        var f = r(Object.keys(e.properties)),
                                            h = f.next();
                                        !h.done;
                                        h = f.next()
                                    ) {
                    ...
                    b = (function () {
                        ...
                        return (
                            ...
                            (t.prototype.convert = function (t, e) {
                                ...
                                return (
                                    (y.start.node = this.adaptor.body(
                                        this.document
                                    )),
                ...
                var f = (function (t) {
                    ...
                    return (
                        ...
                        (r.prototype.copy = function (t) {
                            ...
                            if (
                                ((s.properties = i({}, this.properties)),
                                this.attributes)
                            ) {
                            ...
                            if (this.childNodes && this.childNodes.length) {
                                ...
                                try {
                                    for (
                                        ...
                                        var y = d.value;
                                        y
                                            ? s.appendChild(y.copy())
                                            : s.childNodes.push(null);
                                    }
                                } catch (t) {
                                    n = { error: t };
                                } finally {
                        ...
                        (e.prototype.setChildInheritedAttributes = function (
                            ...
                            try {
                                for (
                                    ...
                                    var u = l.value;
                                    u instanceof f &&
                                        u.setInheritedAttributes(t, e, r, n);
                                }
                            } catch (t) {
                                o = { error: t };
                            } finally {
                ...
                var y = (function (t) {
                    ...
                    return (
                        ...
                        (r.prototype.setTeXclass = function (t) {
                            ...
                            try {
                                for (
                                    var i = a(this.childNodes.slice(1)),
                                        s = i.next();
                                    !s.done;
                                    s = i.next()
                                ) {
            ...
            3948: function (t, e, r) {
                ...
                var a = r(9007),
                    ...
                    l = (function (t) {
                        ...
                        return (
                            ...
                            (e.defaults = i(
                                {},
                                a.AbstractMmlBaseNode.defaults
                            )),
                            e
                        );
                ...
                (e.TeXAtom = l),
                    (l.prototype.adjustTeXclass =
                        s.MmlMo.prototype.adjustTeXclass);
            },
            9145: function (t, e, r) {
                var n,
                    o =
                ...
                var a = r(9007),
                    ...
                    l = (function (t) {
                        ...
                        return (
                            ...
                            (e.defaults = i(
                                i({}, a.AbstractMmlLayoutNode.defaults),
                        ...
                        return (
                            ...
                            (e.prototype.addFakeNodes = function () {
                                ...
                                if (
                                    ...
                                    try {
                                        for (
                                            var u = a(this.childNodes.slice(1)),
                                                c = u.next();
                                            !c.done;
                                            c = u.next()
                                        ) {
                ...
                var a = r(9007),
                    s = (function (t) {
                        ...
                        return (
                            ...
                            (e.defaults = i(
                                i({}, a.AbstractMmlTokenNode.defaults),
                                {
                                    alt: "",
                                    src: "",
                                    width: "auto",
                ...
                var a = r(9007),
                    s = (function (t) {
                        ...
                        return (
                            ...
                            (e.defaults = i(
                                {},
                                a.AbstractMmlTokenNode.defaults
                            )),
                                ...
                                if (p) {
                                    ...
                                    if (y) {
                                        void 0 ===
                                            ...
                                            (this.texClass = y[2]);
                                        var O =
                                            this.constructor.MMLSPACING[y[2]];
                ...
                var a = r(9007),
                    s = (function (t) {
                        ...
                        return (
                            ...
                            (e.defaults = i(
                                {},
                                a.AbstractMmlLayoutNode.defaults
                            )),
                            e
                        );
                    })(a.AbstractMmlLayoutNode);
                ...
                var l = r(5722),
                    ...
                    d = (function (t) {
                        function e(e, r, n) {
                            ...
                            return (
                                ((o =
                                    t.call(this, e, r, s) || this).domStrings =
                                    o.options.DomStrings ||
                                    new f.HTMLDomStrings(l)),
                ...
                function a(t, r) {
                    ...
                    if (e.options.loadMissingEntities) {
                        ...
                        i[a] ||
                            ((i[a] = !0),
                            n.retryAfter(
                                o.asyncLoad("./util/entities/" + a + ".js")
                            ));
                    }
                    return t;
                }
                        ...
                        if (
                            ...
                            ((1 === d.length &&
                                ...
                                ? (f[e.REMOVE] &&
                                  ...
                                  f[e.APPEND] &&
                                      (t[r] = o(o([], n(h)), n(f[e.APPEND]))))
                                : p(h, f, l);
                        }
                    };
                    try {
                        for (
                            var y = r(u(i)), O = y.next();
                            !O.done;
                            O = y.next()
                        ) {
                            d(O.value);
                ...
                function M(t) {
                    ...
                    try {
                        for (
                            ...
                            try {
                                for (
                                    var h = ((i = void 0), r(Object.keys(O))),
                                        d = h.next();
                                    !d.done;
                                    d = h.next()
                                ) {
